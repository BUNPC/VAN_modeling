...
function MCproton_Hybrid11(B0,phi_angle,omega_angle,TE,Gx,ROIx,ROIy,ROIz,file_name,iFrame,volume_and_mesh_file,vol_iFrame,ref_file,ref_iFrame,vol_ref_iFrame,VesselDiPercent,savefolder,cmro2,dChi0)
...
save([savefolder,'/Beta_Vweighted/MCBOLD',num2str(VesselDiPercent),'_',num2str(cmro2),'_',num2str(dChi0*10^6),'.mat'],'tMCproton','TE','signal_GE','signal_SE','signal_GE_IV','signal_SE_IV','signal_GE_EV','signal_SE_EV',...
