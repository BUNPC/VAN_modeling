...
function MCproton_Hybrid_FineResolution_noGX2(B0,phi_angle,omega_angle,TE,Gx,ROIx,ROIy,ROIz,file_name,iFrame,volume_and_mesh_file,vol_iFrame,ref_file,ref_iFrame,vol_ref_iFrame,VesselDiPercent,savefolder,cmro2)
...
save([savefolder,'/FineResolution/ROI_MCBOLD_B0_',num2str(B0),'VesselDiPercent_',num2str(VesselDiPercent),'_cmro2_',num2str(cmro2),'.mat'],'tMCproton','TE','signal_GE','signal_SE','signal_GE_IV','signal_SE_IV','signal_GE_EV','signal_SE_EV',...
